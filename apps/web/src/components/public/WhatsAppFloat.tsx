...
/**
 * Floating WhatsApp action shown on every public page.
 *
 * The number, prefilled message and URL come from the generated public-content
 * snapshot, so they are edited once in scripts/generate-public-content.mjs.
 */
export function WhatsAppFloat() {
  const { whatsapp } = publicContent.contacts;
