...
The Publication fixture still shows a selected-draft overlay: the hero heading is the saved draft (version 1), while the omitted contact heading stays canonical (`Contact Us`). Prepare does not send version `0`.
...
Fixtures: `fixtures/inbox.html`, `fixtures/content.html`, `fixtures/publication.html`. Capture script: `scripts/capture-prompt-17-chrome.py`.
