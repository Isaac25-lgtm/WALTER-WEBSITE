"""Capture Prompt 14 /walter/ and fixture-driven inbox/content/publication layouts."""
...
FIXTURES = ROOT / "project" / "visual-checks" / "prompt-14" / "fixtures"
DEST = ROOT / "project" / "visual-checks" / "prompt-14"
    ...
    with sync_playwright() as playwright:
        ...
        for width, height in VIEWPORTS:
            ...
            records[f"inbox_{suffix}"] = {
                ...
                "phone": page.get_by_text("+256 700 000 000").count(),
            ...
            records[f"publication_{suffix}"] = {
                "h2": page.locator("h2").inner_text(),
                "create": page.get_by_text("Create local snapshot").count(),
