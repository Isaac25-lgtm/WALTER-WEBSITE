"""Capture Prompt 15 /walter/ and fixture-driven inbox/content/publication layouts."""
...
FIXTURES = ROOT / "project" / "visual-checks" / "prompt-15" / "fixtures"
DEST = ROOT / "project" / "visual-checks" / "prompt-15"
