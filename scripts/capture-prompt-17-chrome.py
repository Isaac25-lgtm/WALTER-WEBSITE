"""Capture Prompt 17 /walter/ and fixture-driven inbox/content/publication layouts."""
...
FIXTURES = ROOT / "project" / "visual-checks" / "prompt-17" / "fixtures"
DEST = ROOT / "project" / "visual-checks" / "prompt-17"
