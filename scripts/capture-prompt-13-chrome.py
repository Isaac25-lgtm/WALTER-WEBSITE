"""Capture Prompt 13 /walter/ and fixture-driven inbox/content layouts."""
...
FIXTURES = ROOT / "project" / "visual-checks" / "prompt-13" / "fixtures"
DEST = ROOT / "project" / "visual-checks" / "prompt-13"
    ...
    with sync_playwright() as playwright:
        ...
        for width, height in VIEWPORTS:
            ...
            records[f"inbox_{suffix}"] = {
                ...
                "load_more": page.get_by_text("Load more inquiries").count(),
            }
